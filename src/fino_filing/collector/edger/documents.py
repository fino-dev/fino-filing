...
from ._helpers import build_edgar_filing, parse_edgar_date, parse_meta_to_parsed
        ...
        for cik in cik_list:
            ...
            for i in range(n):
                ...
                meta: dict[str, Any] = {
                    ...
                    "form_type": form,
                    "filing_date": parse_edgar_date(filing_date_s),
                    "period_of_report": parse_edgar_date(report_date_s),
